...
require_once(get_template_directory().'/lib/custom-post-type.php'); // you can disable this if you like
...
$sidebars = array('Offcanvas');
foreach ($sidebars as $sidebar) {
    register_sidebar(array(
        'id' => 'Offcanvas',
        'name' => __('Offcanvas', 'reverie'),
        'description' => __('The offcanvas sidebar.', 'reverie'),
